...
<body>
	...
	<div class="about-w3l agileits">
		<div class='container'>
			<center>
				<a href="http://www.indiasquash.com/tournament-calendar.aspx" target="_blank" class="btn btn-warnning"
					role="button" style="font-weight:bold"><span class="glyphicon glyphicon-check"></span>Tournament
					calendar India/International</a>
			</center>
		</div>
		<br>
		<div class="container">
			...
			<!--<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Tournament
						<small></small>
					</h1>
					<ol class="breadcrumb">
							...
							<thead>
								<tr>
									...
									<th bgcolor="blue"><strong><span style="color:#F0FFFF;">Proposal
												Dates</span></strong></th>
									<th bgcolor="blue"><strong><span style="color:#F0F8FF;">Category</span></strong>
									</th>
								</tr>
							</thead>
							<tbody>
