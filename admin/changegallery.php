...
$sql="update tbl_gallery set image=:gimage where Id=:Gid";
            ...
            <div class="graphs">
                <div class="xs">
                    ...
                    <div class="tab-content">
                        ...
                        <?php 
$Gid=intval($_GET['Gid']);
$sql = "SELECT image from tbl_gallery where Id=:Gid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':Gid', $Gid, PDO::PARAM_STR);
$query->execute();
...
?>
                        <form class="form-horizontal" name="category"  method="post" enctype="multipart/form-data">
                                ...
                                <img src="images/<?php echo htmlentities($result->image);?>"  style="width:100%;height:50%;">
                                </div>
                                <div class="form-group">
