...
header('location:dashoard.php');
    ...
    if(isset($_GET['eid'])){
        ...
        $sql="DELETE FROM tbl_event WHERE Id=:eid";
...
<head>
  <title>Calcutta Racket Club || Manage Events</title>
      ...
      <div class="container">
        ...
        <div class="margin">
          <div class="row">
            ...
            <div class="col-md-6"><a href="addevent.php"><button type="submit" class="btn btn-default">Add
                  Event</button></a></div>
          </div>
        </div>
