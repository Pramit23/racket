...
header('location:dashoard.php');
    ...
    if(isset($_GET['coid'])){
        ...
        $sql="DELETE FROM tbl_courses WHERE id=:coid";
...
<head>
  <title>Calcutta Racket Club||Manage Course List</title>
      ...
      <div class="container">
        <div class="margin">
          <div class="row">
            ...
            <div class="col-md-6"><a href="addcourse.php"><button type="submit" class="btn btn-default">Add
                  Course</button></a></div>
          </div>
        </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <?php $sql = "SELECT * from tbl_courses";
$query = $dbh -> prepare($sql);
