...
$description=$_POST["description"];
	...
	$sql="update tbl_courses set image=:image,name=:name,description=:description where id=:cid";
...
$query->execute();
	...
	$sql="update tbl_courses set name=:name,description=:description where id=:cid";
	$query = $dbh->prepare($sql);
...
<head>
    <title>Calcutta Racket Club||Update Course</title>
                ...
                <div class="xs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <?php 
$cid=intval($_GET['cid']);
$sql = "SELECT * from tbl_courses where id=:cid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':cid', $cid, PDO::PARAM_STR);
$query->execute();
...
?>
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <a href="change_course_image.php?Cid=<?php echo htmlentities($result->id);?>"
                                        style="color:black; font:sans-serif;">
                                        Change Course Image</a>
                                </div>
