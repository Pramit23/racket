...
header('location:dashoard.php');
    ...
    if(isset($_GET['comid'])){
        ...
        $sql="DELETE FROM tbl_comms WHERE Id=:comid";
    ...
    <div id="page-wrapper">
      ...
      <div class="container">
        <div class="margin">
          <div class="row">
            <div class="col-md-6">
              <h2>Communication Lists</h2>
            </div>
            <div class="col-md-6"><a href="add_comms.php"><button type="submit" class="btn btn-default">Add
                  Communication Details</button></a></div>
          </div>
        </div>
...
{				?>
            <tr>
              ...
              <td><strong><?php echo $result->post ?></strong></td>
              <td><strong><?php echo $result->number ?></strong></td>
              <td><a href="update_comms.php?coid=<?php echo $result->Id ?>" class="btn btn-primary"
                  title="" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>&nbsp;<a
                  href="comms_list.php?comid=<?php echo $result->Id ?>"
